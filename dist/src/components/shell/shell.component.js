System.register(['angular2/core', 'angular2/router', '../movies/movies.service', '../sidebar/sidebar.component', '../filters/filters.component'], function(exports_1) {
    ...
    var core_1, router_1, movies_service_1, sidebar_component_1, filters_component_1;
    var ShellComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            ShellComponent = (function () {
                function ShellComponent(_routeParams, _moviesService) {
                ...
                ShellComponent.prototype.ngOnInit = function () {
                    ...
                    this.setSelectedMovie(this._routeParams.params);
                };
                ...
                ShellComponent.prototype.routerOnReuse = function (next, prev) {
                    this.setSelectedMovie(next.params);
                };
                ...
                ShellComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.RouteParams, movies_service_1.MoviesService])
                ], ShellComponent);
