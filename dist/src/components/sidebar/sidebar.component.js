    ...
    return {
        ...
        execute: function() {
            SidebarComponent = (function () {
                function SidebarComponent(_moviesService, _router) {
                ...
                SidebarComponent = __decorate([
                    core_1.Component({
                        selector: 'sidebar',
                        template: "\n      <h2>Movies</h2>\n      <ul class=\"nav\">\n        <li *ngFor=\"#movie of movies\" [class.active]=\"selectedMovie.id == movie.id\">\n          <a (click)=\"setSelectedMovie(movie)\">{{movie.title}}</a>\n        </li>\n      </ul>\n    ",
